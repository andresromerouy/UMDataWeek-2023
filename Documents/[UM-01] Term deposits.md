...
Q6. Suppose that you decide to use your model as suggested in question Q5, but calling 20% of the clients. How would you validate your model for that application, based on a **train/test split**?
